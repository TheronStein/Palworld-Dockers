...
ENV DEBIAN_FRONTEND=noninteractive \
    ...
    WEBHOOK_URL="chaoscore.org/webhooks/" \
    ...
    PAL_DAMAGE_RATE_ATTACK=1.250000 \
    PAL_DAMAGE_RATE_DEFENSE=1.000000 \
    PLAYER_DAMAGE_RATE_ATTACK=1.000000 \
    PLAYER_DAMAGE_RATE_DEFENSE=1.000000 \
    PLAYER_STOMACH_DECREASE_RATE=1.250000 \
    PLAYER_STAMINA_DECREACE_RATE=1.000000 \
    PLAYER_AUTO_HP_REGENE_RATE=0.750000 \
    ...
    MAX_PLAYERS=32 \
    SERVER_NAME="[R]enegades Palworld Server2" \
    SERVER_DESCRIPTION="Therons awesome palworld server" \
    ADMIN_PASSWORD=THEBEST123! \
    SERVER_PASSWORD=theronrocks \
    PUBLIC_PORT=8212 \
    PUBLIC_IP="chaoscore.org" \
    RCON_ENABLED=true \
    RCON_PORT=25576 \
    REGION=US \
    USEAUTH=true \
